...
source-test-with-cache-to-url   Ready   35m   apps.jaguchi.maki.lol/has-cache=true,apps.tanzu.vmware.com/has-tests=true,apps.tanzu.vmware.com/workload-type=web <<--- 🆕
